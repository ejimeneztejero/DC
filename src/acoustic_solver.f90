...
subroutine solver(rank,iDC,nSS,nxx,nySou,nyRec,S,ny,nx,ctmp,shot_synth)
...
implicit none
	...
	!!!! Simulation Geometry
	integer i,ny,nx,j,k,dn,ix,rank
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
	...
	if(rank.eq.0) call time_rate(k,nt)
...
subroutine time_rate(k,nt)
        ...
        integer :: i,k,nt,xt
                ...
                do i=1,10
                        if(k.eq.xt*i) write(*,*)i*10,"% propagation done"
                enddo

end subroutine time_rate
